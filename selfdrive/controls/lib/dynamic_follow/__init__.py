...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == self.df_profiles.traffic:  # for in congested traffic
      ...
      #y_dist = [0.9095, 0.9102, 0.8882, 0.8668, 0.8676, 0.8699, 0.89, 0.8296, 0.755, 0.6461, 0.6244, 0.6043]
      y_dist = [0.9371, 0.9378, 0.9151, 0.8931, 0.8939, 0.8962, 0.89, 0.8296, 0.755, 0.6461, 0.6244, 0.6043]
