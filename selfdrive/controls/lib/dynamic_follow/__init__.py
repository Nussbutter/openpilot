...
#OG x_vel = [0.0, 1.892, 3.7432, 5.8632, 8.0727, 10.7301, 14.343, 17.6275, 22.4049, 28.6752, 34.8858, 40.35]  # velocities
#OG y_dist = [1.3781, 1.3791, 1.3457, 1.3134, 1.3145, 1.318, 1.3485, 1.257, 1.144, 0.979, 0.9461, 0.9156]
#Attempt 2 y_dist = [0.9371, 0.9378, 0.9151, 0.8931, 0.8939, 0.8962, 0.89, 0.8296, 0.755, 0.6461, 0.6244, 0.6043]
    if df_profile == self.df_profiles.traffic:  # for in congested traffic
      ...
      x_vel = [0.0, 2.25, 4.5, 6.75, 9, 11.25, 13.5, 15.75, 18, 20.25, 22.5, 24.75, 27, 29.25, 31.75, 33.75, 36, 38.25, 40.5]  # velocities
      #y_dist = [1.25, 1.24, 1.23, 1.22, 1.21, 1.20, 1.18, 1.16, 1.13, 1.11, 1.09, 1.07, 1.05, 1.05, 1.05, 1.05, 1.05, 1.05, 1.05]
      y_dist = [1.0625, 1.054, 1.0455, 0.9333, 0.9256, 0.918, 0.9027, 0.8874, 0.8645, 0.8492, 0.8338, 0.8185, 0.8033, 0.8033, 0.8033, 0.8033, 0.8033, 0.8033, 0.8033]
    elif df_profile == self.df_profiles.stock:  # default to stock - Reduced to 1.1
      #return 1.45
      return 1.2
